                ...
                <div className={styles.carousel}>
                    {[1, 2, 3, 4].map(num => (
                        ...
                        <div key={num} id={`card${num}`} ref={el => cardRefs.current[num - 1] = el} className={`${styles.card} `}>
                            ...
                            {num === 2 && (
                                <div  className={`${styles.section1} ${styles.card}`}>
                                    <p>
                            ...
                            {num === 3 && (
                                <div className={`${styles.section2} ${styles.card}`}>
                                    <p>
                            ...
                            {num === 4 && (
                                <div className={`${styles.section3} ${styles.card}`}>
                                    <p><b className={styles.subs3}>Working With Me</b><br /> <br />I like keeping things <b>simple and transparent</b> with my clients. I’ll work with you to understand what you need, and I'll keep you updated as I bring our shared <b>vision to life</b>. I love Agile methodologies and I'm always open to feedback.
                                    </p>
                                </div>)}
                        </div>
                    ))}
